...
def project_root() -> Path:
    """Return the ``docs/tutorials/spatial_extremes`` directory."""
    # data.py -> spatial_extremes -> _helpers -> spatial_extremes (tutorial)
...
def default_cache_root() -> Path:
    ...
    falls back to ``docs/tutorials/spatial_extremes/data``.
    """
